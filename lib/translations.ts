export const translations = {
  en: {
    ...
    selectFlightClass: "Select Flight Class",
  ...
  ar: {
    ...
    selectStars: "اختر تصنيف النجوم",
    selectFlightClass: "اختر درجة الطيران",
    selectTransmission: "اختر نوع ناقل الحركة",
  ...
  tr: {
    ...
    childGuests: "Çocuk Sayısı",
    hotelStars: "Otel Yıldız Sayısı",
    ...
    selectCarType: "Araç Tipi Seçin",
    selectStars: "Yıldız Sayısı Seçin",
    selectFlightClass: "Uçuş Sınıfı Seçin",
    selectTransmission: "Vites Tipi Seçin",
    selectFuel: "Yakıt Tipi Seçin",
